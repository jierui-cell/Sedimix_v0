...
_, model, input_file, centrifuge_db, postfix = sys.argv
...
def run_centrifuge(input_file, postfix, centrifuge_db):
    centrifuge_cmd = f"{centrifuge_path}centrifuge -x {centrifuge_path}{centrifuge_db} -S {postfix}.centrifuge --report-file {postfix}.centrifugeLog -U {input_file}"
