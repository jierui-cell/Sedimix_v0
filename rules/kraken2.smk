...
rule classification:
    input:
        "mapping/{sample}_L30MQ25.fq"
    output:
        kraken2_results="classification/{sample}_L30MQ25.kraken2", 
        kraken2_report="classification/{sample}_L30MQ25.k2report" 
    # change index to nt_db (710GB) if needed
    params:
        kraken2_path="/global/home/users/jieruixu/jieruixu/sediment_dna/peerj_replication/kraken2/", 
        kraken2_db="standard_db" # database size: 72GB  
    benchmark:
...
rule generate_classified_reads:
    input:
        kraken2_result="classification/{sample}_L30MQ25.kraken2",
